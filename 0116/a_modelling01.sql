...
# 데이터 모델링
# : 작성하고자 하는 데이터베이스를 정의하여 논리적인 데이터 모델을 구성하는 작업
...
-- 데이터 베이스 테이블 정의
-- 학생 테이블 : 학번(기본키), ..나머지 
-- 교사 테이블 : 교직원번호(기본키), ..나머지 
-- 수업 테이블 : 과목명(기본키), 담당교사(외래키), ..나머지 
-- 수강 테이블 : 학번(학생 테이블 값), 과목명(수업 테이블 값) 
-- /ㄴ학생과 수업은 연관이 없음/ 기본키와 외래키를 통해 연결/ 
